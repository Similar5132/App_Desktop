...
public class Administrador extends javax.swing.JFrame {
    ...
    public Administrador() {
        initComponents();
        user = Login.user; // variable user de laotra interfazzz login como es estatico solo pongo nombre de la clase que es Login.user y lo asigno a la variable xd
        sesion_usuario = 1; //variable funcion bandera
        ...
        setDefaultCloseOperation(WindowConstants.EXIT_ON_CLOSE); //Metodo para matar procesos en segundo plano, cuando la ventana se cierre.

        ImageIcon wallpaper = new ImageIcon("src/images/wallpaperPrincipal.jpg");
        Icon icono = new ImageIcon(wallpaper.getImage().getScaledInstance(jLabel_wallppaper.getWidth(),
                jLabel_wallppaper.getHeight(), Image.SCALE_DEFAULT));
        jLabel_wallppaper.setIcon(icono);
        this.repaint();

        try {
            Connection cn = conexion.conectar();
            PreparedStatement pst = cn.prepareStatement("select nombre_usuario from usuarios where username = '" + user + "'"); //Por ejemplo, si el valor de la variable "user" es "juan", la consulta SQL resultante sería:
    ...
    private void initComponents() {
        ...
        jLabel_wallppaper = new javax.swing.JLabel();
        ...
        getContentPane().add(jLabel_wallppaper, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 660, 450));
    ...
    private javax.swing.JLabel jLabel_wallppaper;
