            ...
            if (rs.next()) {
                ...
                if (validacion == 0) {
                    try {
                        ...
                        this.dispose(); //es un método que se utiliza en programación para liberar los recursos que ha utilizado un objeto y eliminarlo de la memoria
...
// aui van los metodos que creo yo 
