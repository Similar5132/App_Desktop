    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (validacion == 0) {
            try {
                ...
                this.dispose();//se usa para cerrar una ventana o un cuadro de diálogo y liberar los recursos en este caso se cierra la ventana Registrar clientes

            } catch (SQLException e) {
                System.out.println("Error en rregistrar cliente." + e);
                JOptionPane.showMessageDialog(null, "Error al registrar cliente, contacte al Administrtador");
            }
        } else {
