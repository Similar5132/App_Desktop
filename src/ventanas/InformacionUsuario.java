...
public class InformacionUsuario extends javax.swing.JFrame {
    ...
    public InformacionUsuario() {
        ...
        setSize(630, 450);
        setResizable(false);
        setTitle("Informacion del usario " + user_update + " -Sesion de " + user);
        setLocationRelativeTo(null);

        setDefaultCloseOperation(WindowConstants.DISPOSE_ON_CLOSE); // el programa finalize cuando la venta se cierre
    ...
    private void initComponents() {
        ...
        txt_username.setBackground(new java.awt.Color(69, 105, 213));
        ...
        txt_RegistradoPor.setBackground(new java.awt.Color(69, 105, 213));
        ...
        getContentPane().add(jLabel_FOOTER, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 380, -1, -1));
    ...
    private void jButton_ActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_ActualizarActionPerformed
        ...
        if (validacion == 0) {
            ...
            try {
                Connection cn = conexion.conectar();
                PreparedStatement pst = cn.prepareStatement("select username from usuarios where  username = '" + username + "' and not id_usuario = '" + ID + "'"); // tipo para wu eno modifique el usuario dque esta consultando 
                ResultSet rs = pst.executeQuery();
                if (rs.next()) {
                    txt_username.setBackground(Color.red);
