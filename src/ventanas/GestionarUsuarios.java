...
public class GestionarUsuarios extends javax.swing.JFrame {
    ...
    public GestionarUsuarios() {
        ...
        try {
            ...
            while (rs.next()) {
                Object[] fila = new Object[5]; // porque son 5 arriba
                for (int i = 0; i < 5; i++) {
            ...
            JOptionPane.showMessageDialog(null, "ERROR al mostrar la informacion, contacte al Administtrador!");

        }

        //OBTENER EL CAMPO QUE LE DE CLICK EL USER
        jTable_usuarios.addMouseListener(new MouseAdapter() {
            @Override
            public void mouseClicked(MouseEvent e) {
                //Obtengo la fila en la que se ha hecho clic
                int fila_point = jTable_usuarios.rowAtPoint(e.getPoint());
                //Obtengo la columna de la que se quiere recuperar información
                int columna_point = 2; // en este caso siempre es la columna 2 osea la celda nombre
                if (fila_point > -1) { //Verificar que se haya hecho clic en una fila válida es decir de la 0 en adelante
                    //Recuperar el valor de la columna específica de la fila en la que se hizo clic
                    user_update = (String) model.getValueAt(fila_point, columna_point);
                    //Crear una nueva ventana para mostrar información adicional del usuario seleccionado
